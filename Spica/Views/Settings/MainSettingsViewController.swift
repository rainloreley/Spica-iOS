...
class MainSettingsViewController: UITableViewController {
	...
	@IBAction func profileMore(_ sender: Any) {
	...
	@IBAction func allesPrivacy(_ sender: Any) {
	...
	@IBAction func allesTerms(_ sender: Any) {
	...
	@IBAction func usedLibraries(_ sender: Any) {
