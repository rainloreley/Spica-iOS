//
// Spica for iOS (Spica)
// File created by Adrian Baumgart on 12.08.20.
//
...
public struct Post: Hashable {
    ...
    var url: String?
    var mentionedPost: MiniPost?

    var mentionedUsers: [User]

    init(id: String = "", author: User? = nil, author_id: String = "", parent_id: String? = nil, children_ids: [String] = [], children_count: Int = 0, content: String = "", imageURL: URL? = nil, image: UIImage? = nil, score: Int = 0, voted: Int = 0, created: Date = Date(), mentionedUsers: [User] = [], interactions: Int? = nil, url: String? = nil, mentionedPost: MiniPost? = nil) {
        ...
        self.url = url
        self.mentionedPost = mentionedPost
    }
